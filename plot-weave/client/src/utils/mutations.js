...
mutation addUser($username: String!, $email: String!, $password: String!, $bio: String!, $profilePicture: Upload) {
  addUser(username: $username, email: $email, password: $password, bio: $bio, profilePicture: $profilePicture) {
    token
    user {
      _id
      username
